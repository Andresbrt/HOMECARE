...
public class CalificacionService {
    ...
    public CalificacionDTO.Response calificar(Long calificadorId, CalificacionDTO.Crear request) {
        ...
        calificacion.setTipo(esCliente ? Calificacion.TipoCalificacion.CLIENTE_A_PROVEEDOR : Calificacion.TipoCalificacion.PROVEEDOR_A_CLIENTE);
    ...
    private CalificacionDTO.Response mapToResponse(Calificacion calificacion) {
        return new CalificacionDTO.Response(
                ...
                calificacion.getTipo() != null ? calificacion.getTipo().name() : "CLIENTE_A_PROVEEDOR",
                calificacion.getCreatedAt() != null ? calificacion.getCreatedAt().toString() : java.time.LocalDateTime.now().toString()
        );
    }
}
