...
public class EnvironmentValidator implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        if (isEmpty(mpAccessToken)) {
            missingVariables.add("MP_ACCESS_TOKEN (requerido para pagos)");
        }
        
        if (isEmpty(mpPublicKey)) {
            missingVariables.add("MP_PUBLIC_KEY (requerido para pagos)");
        }
        ...
        log.info("🚀 Entorno: {} | JWT: ✓ | Google Maps: ✓ | Supabase: ✓ | Mercado Pago: {}", environment, !isEmpty(mpAccessToken) ? "✓" : "✗");
        log.info("");
        log.info("╔═══════════════════════════════════════════════════════════╗");
        log.info("║                                                           ║");
