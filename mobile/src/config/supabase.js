...
const supabaseUrl = extra.supabaseUrl || process.env.SUPABASE_URL || 'https://placeholder.supabase.co';
const supabaseAnonKey = extra.supabaseAnonKey || process.env.SUPABASE_ANON_KEY || 'placeholder-anon-key';

if (!extra.supabaseUrl && !process.env.SUPABASE_URL) {
  console.warn(
