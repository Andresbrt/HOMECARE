...
- **Auth:** Supabase Auth + JWT + Spring Security (RBAC)
- **Real-time:** WebSocket (STOMP) + Supabase Realtime
...
- ✅ **Integrations:** Mercado Pago, Google Maps, Supabase, Brevo
...
- 2026-04-04: Se creó `services/storageService.js` para upload de avatares a Supabase Storage (usa ImageManipulator para resize)
...
- 2026-09-02: Erradicación total de Firebase y migración completa a Supabase (PostgreSQL + Realtime + Storage)
- 2026-09-02: Blindaje de Google OAuth (WebBrowser + PKCE + nativo) y validación dual de tokens en backend (HMAC local + Supabase Auth API /auth/v1/user)
- 2026-09-02: Botón de eliminación de cuenta (Apple Guideline 5.1.1 / GDPR) implementado en Backend (DELETE /api/usuarios/me) y Mobile (ProfileScreen)
- 2026-09-02: Términos y Condiciones y Política de Habeas Data bajo legislación colombiana (Ley 1480/2011 art 53 y Ley 1581/2012) creados in-app y en markdown
...
- Supabase Storage configurado para perfiles y evidencias (`storageService.js`)
